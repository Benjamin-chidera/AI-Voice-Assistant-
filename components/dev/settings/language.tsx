  ...
  return (
    <View>
      <View className="mt-10">
        <Text className="text-white font-bold text-lg">Language</Text>
        ...
        >
          <View className=" flex flex-row  gap-5 items-center">
            ...
            <View>
              <Text className="text-white font-bold text-lg">Language Selection</Text>
              <Text className="text-gray-200 text-lg">English</Text>
            </View>
          </View>
